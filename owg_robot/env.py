...
class Environment:
    ...
    def pick_obj_by_id(self,
        ...
        return succes_grasp, grasped_obj_id, j + 1, None
    ...
    def put_obj_in_loc(self,
        ...
        # pick object by id
        succes_grasp, grasped_obj_id, num_attempts, grasp = self.pick_obj_by_id(
            obj_id, vis=vis, grasp_indices=grasp_indices)

        if not succes_grasp:
            print('Grasping failed. Exitting')
            return False, False, num_attempts
        ...
        return succes_grasp, succes_target, num_attempts
